...
const cargarImagen = (id, nombre, ruta, descripcion) => {
    ...
    galeria$4.querySelector('.galeria__imagen').dataset.idImagen = id; //Creamos un atributo personalizado
    galeria$4.querySelector('.galeria__titulo').textContent = nombre;
    galeria$4.querySelector('.galeria__descripcion-imagen-activa').textContent = descripcion;
    ...
    if (galeria$4.querySelectorAll('.galeria__carousel-slide') > 0) {
...
const cargarAnteriorSiguiente = (direccion) => {
    const categoriaActual = galeria$4.dataset.categoria;
    const fotos = datos.fotos[categoriaActual];
    const idImagenActual = Number(galeria$4.querySelector('.galeria__imagen').dataset.idImagen);
    let indexImagenActual;
    fotos.forEach((foto, index) => {
...
contenedorCategorias.addEventListener('click', (e) => {
    ...
    if (e.target.closest('a')) {
        ...
        galeria$3.dataset.categoria = categoriaActiva; // añadimos una nueva categoria

        const fotos = datos.fotos[categoriaActiva]; //vemos las fotos de esa categoria
        ...
        galeria$3.querySelector('.galeria__carousel-slides').classList.add('galeria__carousel-slides--active');
    }
